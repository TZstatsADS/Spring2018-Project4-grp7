...
# load data
setwd("~/GitHub/Spring2018-Project4-grp7/data")
test <- read.csv("ms_test.csv")
test <- test[,-1]
test2 <- test[1:100,]

setwd("~/GitHub/Spring2018-Project4-grp7/output/memory_based_predict/ms")
load("ms_pearson_threshold.Rdata")
pred_pear_thr <- ms_pearson_threshold
load("ms_vector_threshold.Rdata")
pred_vec_thr <- ms_vector_threshold
load("ms_simrank_threshold.Rdata")
pred_sim_thr <- ms_simrank_threshold

load("ms_pearson_bestn.Rdata")
pred_pear_bn <- ms_pearson_bestn
load("ms_vector_bestn.Rdata")
pred_vec_bn <- ms_vector_bestn
load("ms_simrank_bestn.Rdata")
pred_sim_bn <- ms_simrank_bestn

load("ms_pearson_comb.Rdata")
pred_pear_cb <- ms_pearson_comb
load("ms_vector_comb.Rdata")
pred_vec_cb <- ms_vector_comb
load("ms_simrank_comb.Rdata")
pred_sim_cb <- ms_simrank_comb
